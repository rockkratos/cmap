...
<tr>
    ...
    <td>
		...
		<a href="javascript:void(0);" title="删除" onclick="javascript:cmap.delete('${rc.contextPath}/adminPrivilege/${tmpPrivilege.privilegeId}', 'privilegeListHint', 'Pagination', 'privilegeForm');"><img src="${rc.contextPath}/imgs/admin/icons/cross.png" /></a>
	</td>

...
<tr>
    ...
    <td>
    	<@sec.authorize url="/adminCustomerMgr/{id}" method="PUT">
		...
		<@sec.authorize url="/adminCustomerMgr/detail/{id}" method="GET">
		...
		<@sec.authorize url="/adminCustomerMgr/{id}" method="DELETE">

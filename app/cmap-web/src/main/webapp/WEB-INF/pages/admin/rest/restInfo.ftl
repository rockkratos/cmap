...
<div class="content-box-content clearfix">
	...
	<div class="column-right">
		...
		<p>
	        <label>生效时间*</label>
	        <input id="detailRestStartTime" name="detailRestStartTime" type="text" readonly="readonly" class="date-txt w200" value="${restInfoVo.restStartTime?string('yyyy-MM-dd')}" />
	    </p>
	    <p>
	        <label>失效时间*</label>
	        <input id="detailRestEndTime" name="detailRestEndTime" type="text" readonly="readonly" class="date-txt w200" value="${restInfoVo.restEndTime?string('yyyy-MM-dd')}" />
	    </p>
	    <p>
	        <label>打印联数</label>
	        <#if ((restInfoVo.printJointNum!0)?number) != 0>
	        <input id="detailPrintJointNumShow" type="text" class="dropdown w200" readonly="readonly" value="${((restInfoVo.printJointNum?number) == 2)?string('二联', '三联')}" />
	        <#else>
	        <input id="detailPrintJointNumShow" type="text" class="dropdown w200" readonly="readonly" />
	        </#if>
